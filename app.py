...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:21363115g@localhost/Glasgow_Toilet_Map'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

app.config['MAIL_SERVER']='smtp.mailtrap.io'
app.config['MAIL_PORT'] = 2525
app.config['MAIL_USERNAME'] = 'd53644964ee663'
app.config['MAIL_PASSWORD'] = '620db34e05d446'
